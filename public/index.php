...
// Base path is now auto-detected!
// It will automatically detect /wrightcommerce/public for local XAMPP
// and adjust to / when you deploy to production
...
$router->group('/api/v1', function($router) {
    ...
    // Additional product routes (MUST come BEFORE the /products/{id} route to avoid conflicts)
    ...
    // Product actions (with specific IDs)
